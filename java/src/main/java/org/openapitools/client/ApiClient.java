...
public class ApiClient {
    ...
    private String basePath = "https://api.financial.inca.digital";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.financial.inca.digital",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.financial.inca.digital
